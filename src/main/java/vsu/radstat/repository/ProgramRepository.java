...
public class ProgramRepository {
    ...
    public void insert(ProgramEntity entity) throws Exception {
        if (storage.containsKey(entity.getProgramId())) {
            throw new Exception("Already has this program");

        }
        storage.put(entity.getProgramId(), entity);
    }
